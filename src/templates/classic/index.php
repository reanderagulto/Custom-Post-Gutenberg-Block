...
?>
<p <?php echo wp_kses_data( get_block_wrapper_attributes() ); ?> class="template">
	<?php
	if ( isset( $attributes['selectedTheme'] ) ) {
		/**
		...
		echo wp_kses_post( $attributes['selectedTheme'] . ' | ' . get_bloginfo( 'name' ) );
	}
	?>
</p>